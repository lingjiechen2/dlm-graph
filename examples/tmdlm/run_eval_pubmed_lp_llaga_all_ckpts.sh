...
# PubMed LP run (LLaGA-split, 8 GPU, 5 epochs). One GPU sequential across the
...
#
# Usage: sbatch examples/tmdlm/run_eval_pubmed_lp_llaga_all_ckpts.sh
#
...
#SBATCH --job-name=pubmed-lp-eval
#SBATCH --output=/mnt/weka/home/lingjie.chen/model/dlm-graph/logs/pubmed_lp_eval_%j.log
#SBATCH --error=/mnt/weka/home/lingjie.chen/model/dlm-graph/logs/pubmed_lp_eval_%j.log
...
RUN_DIR="${RUN_DIR:-/mnt/weka/home/lingjie.chen/model/dlm-graph/tmdlm-llada-8b-pubmed-lp-2hop-r64-ep5-pubmed_lp_llaga_20260521_1917_8gpu_5ep}"

LOG_DIR=/mnt/weka/home/lingjie.chen/model/dlm-graph/logs
mkdir -p "$LOG_DIR"
LOG_JSONL="${LOG_DIR}/eval_pubmed_lp_llaga_allckpts.jsonl"
...
for CKPT_DIR in "${CKPTS[@]}"; do
  ...
  EXP_TAG="pubmed_lp_llaga_${CKPT_NAME}_${SLURM_JOB_ID:-local}"
  echo
  echo "============================================================"
