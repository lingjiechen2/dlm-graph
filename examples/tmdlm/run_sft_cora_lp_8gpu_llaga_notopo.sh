#!/usr/bin/env bash
# Cora LP SFT on LLaGA's exact train split, no topology mask.
# Mirrors run_sft_cora_lp_8gpu_llaga.sh except:
#   --use_topology_mask False
#
# Usage: sbatch examples/tmdlm/run_sft_cora_lp_8gpu_llaga_notopo.sh
#
...
#SBATCH --job-name=cora-lp-notopo
#SBATCH --output=/mnt/weka/home/lingjie.chen/model/dlm-graph/logs/cora_lp_notopo_%j.log
#SBATCH --error=/mnt/weka/home/lingjie.chen/model/dlm-graph/logs/cora_lp_notopo_%j.log
...
RUN_TAG="cora_lp_llaga_notopo_$(date +%Y%m%d_%H%M)_8gpu_5ep"
run_name="tmdlm-llada-8b-cora-lp-2hop-notopo-r64-ep5-${RUN_TAG}"
