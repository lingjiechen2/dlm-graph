...
# Phase 2c: validate nb=12 / nb=15 / nb=30 on the 3 other ckpts (1640, 2042, final).
# Each (ckpt, setting) is one forward pass = 1000 samples seed=42.
...
LOG_DIR=$WORK/logs
JSONL=$JSONL_DIR/phase2c_other_ckpts.jsonl
...
# 9 runs: ckpt × nb
declare -a SETTINGS=(
  "ckpt1640_nb12  1640 12"
  "ckpt1640_nb15  1640 15"
  "ckpt1640_nb30  1640 30"
  "ckpt2042_nb12  2042 12"
  "ckpt2042_nb15  2042 15"
  "ckpt2042_nb30  2042 30"
  "ckptfinal_nb12 final 12"
  "ckptfinal_nb15 final 15"
  "ckptfinal_nb30 final 30"
)
...
launch_setting() {
  ...
  local EXP=phase2c-${NAME}
  local CKPT=$RUN_DIR/checkpoint-${STEP}
  local NPZ=$LOGITS_DIR/phase2c_${NAME}.npz
  local WLOG=$LOG_DIR/phase2c-${NAME}-gpu${GPU}.worker.log
  : > $WLOG
