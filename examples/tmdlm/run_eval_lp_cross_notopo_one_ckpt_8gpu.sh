#!/usr/bin/env bash
# Single-checkpoint cross-dataset LP eval for ogbn-arxiv targets.
#
# Usage:
#   sbatch --export=ALL,SOURCE_DATASET=cora,TARGET_DATASET=ogbn-arxiv,CKPT_DIR=<path> \
#     examples/tmdlm/run_eval_lp_cross_notopo_one_ckpt_8gpu.sh
...
#SBATCH --job-name=lp-cross-8gpu
#SBATCH --output=/mnt/weka/home/lingjie.chen/model/dlm-graph/logs/lp_cross_8gpu_%j.log
#SBATCH --error=/mnt/weka/home/lingjie.chen/model/dlm-graph/logs/lp_cross_8gpu_%j.log
