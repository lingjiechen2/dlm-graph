...
# Run TM-DLM SFT on Cora WITHOUT neighbor labels (fair baseline comparison).
# Mirror of run_sft_pubmed_nonb_lora.sh with dataset=cora.
#
# Run:
#   GPUS=4,5 bash /home/lingjie7/auto-research/projects/dlm-graph/examples/tmdlm/run_sft_cora_nonb_lora.sh
#
# Optional env vars:
#   GPUS=0,1
#   NUM_EPOCHS=10
