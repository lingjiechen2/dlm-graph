#!/usr/bin/env bash
# Full LLaGA-test eval for the PubMed no-topo LP SFT run.
#
# Usage:
#   sbatch examples/tmdlm/run_eval_pubmed_lp_llaga_notopo_all_ckpts.sh
...
#SBATCH --job-name=pm-lp-notopo-eval
#SBATCH --output=/mnt/weka/home/lingjie.chen/model/dlm-graph/logs/pubmed_lp_notopo_eval_%j.log
#SBATCH --error=/mnt/weka/home/lingjie.chen/model/dlm-graph/logs/pubmed_lp_notopo_eval_%j.log
...
RUN_DIR="${RUN_DIR:-/mnt/weka/home/lingjie.chen/model/dlm-graph/tmdlm-llada-8b-pubmed-lp-2hop-notopo-r64-ep5-pubmed_lp_llaga_notopo_20260523_0829_8gpu_5ep}"
...
for CKPT_DIR in "${CKPTS[@]}"; do
  ...
  EXP_TAG="pubmed_lp_llaga_notopo_${CKPT_NAME}_${SLURM_JOB_ID:-local}"
  echo
  echo "============================================================"
