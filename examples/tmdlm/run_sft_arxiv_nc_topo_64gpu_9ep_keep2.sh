#!/usr/bin/env bash
# ogbn-arxiv NC SFT, topology-masked, 64 H200 (8 nodes x 8), keep latest 2 checkpoints.
#
# Recipe follows the best arxiv NC full-train setting:
#   ogbn-arxiv, task=nc, topo=True, mc_digit/digit0_pad, nonb, seq=4096,
#   LoRA r=128 alpha=128 all-linear, LR=5e-5, 9 epochs.
#
# Usage:
#   sbatch examples/tmdlm/run_sft_arxiv_nc_topo_64gpu_9ep_keep2.sh
#
...
#SBATCH --job-name=arxiv-nc-topo-64g
#SBATCH --output=/mnt/weka/home/lingjie.chen/model/dlm-graph/logs/arxiv_nc_topo_64gpu_keep2_%j.log
#SBATCH --error=/mnt/weka/home/lingjie.chen/model/dlm-graph/logs/arxiv_nc_topo_64gpu_keep2_%j.log
...
RUN_TAG="arxiv_nc_topo_$(date +%Y%m%d_%H%M)_64gpu_9ep_r128_digit0pad_keep2"
run_name="tmdlm-llada-8b-arxiv-nc-2hop-topo-r128-ep9-${RUN_TAG}"
...
echo "[launch] recipe=ogbn-arxiv nc topo=True mc_digit digit0_pad nonb seq4k r128 ep9 save_total_limit=2 cudnn_sdp=${TMDLM_ENABLE_CUDNN_SDP}"
