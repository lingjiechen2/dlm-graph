...
#
# Usage: sbatch examples/tmdlm/run_eval_arxiv_lp_llaga_per_ckpt.sh
#
...
#SBATCH --job-name=arxiv-lp-eval-1ckpt
#SBATCH --output=/mnt/weka/home/lingjie.chen/model/dlm-graph/logs/arxiv_lp_eval_1ckpt_%j.log
#SBATCH --error=/mnt/weka/home/lingjie.chen/model/dlm-graph/logs/arxiv_lp_eval_1ckpt_%j.log
