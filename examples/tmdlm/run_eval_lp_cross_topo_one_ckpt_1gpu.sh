#!/usr/bin/env bash
# Single-checkpoint topo cross-dataset LP eval for Cora/PubMed targets.
#
# Usage:
#   sbatch --export=ALL,SOURCE_DATASET=cora,TARGET_DATASET=pubmed,CKPT_DIR=<path> \
#     examples/tmdlm/run_eval_lp_cross_topo_one_ckpt_1gpu.sh
...
#SBATCH --job-name=lp-cross-topo-1gpu
#SBATCH --output=/mnt/weka/home/lingjie.chen/model/dlm-graph/logs/lp_cross_topo_1gpu_%j.log
#SBATCH --error=/mnt/weka/home/lingjie.chen/model/dlm-graph/logs/lp_cross_topo_1gpu_%j.log
